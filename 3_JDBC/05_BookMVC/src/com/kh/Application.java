...
public class Application {
	...
	public void printBookAll() {
		...
		for(Book book : bc.printBookAll()) {
			System.out.println("책 번호 : " + book.getBkNo() + " / 제목 : " + book.getBkTitle() + " / 저자" + book.getBkAuthor() + " / 출판사" + book.getPublisher().getPubName());
		}
	...
	public void login() {
		...
		if(member!=null) {
		// 로그인에 성공하면 "~~님, 환영합니다!" 출력 후  member
			System.out.println(member.getMembeName() + "님, 환영합니다!");
			memberMenu();
		} else {
		// 실패하면 "로그인에 실패했습니다." 출력
