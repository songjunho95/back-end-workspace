...
public class Application {
	 ...
	 * - 프로그램을 개발하는 기법으로 객체들을 만들고 이러한 개체들을 연결해서 프로그램을 완성하는 기법
	 ...
	 * 2. 캡슐화 : 객체의 속성(필드)와 가능(메서드)을 하나로 묶고 실제 구현 내용을 감추는 것 
	 * 3. 상속 : 하나의 객체가 가지고 있는 속성(필드)와 가능(메서드)를 다른 객체가 물렵다는 것
	 * 4. 다형성 : 같은 타입이지만 실행 결과가 다향한 객체를 이용할 수 있는 성질
	 * 
	 * 클래스
	 ...
	 * - 접근제한자는 public, default, private, protected 등 설 정 가능
