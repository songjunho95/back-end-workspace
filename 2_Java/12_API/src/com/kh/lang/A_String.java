...
public class A_String {
	...
	public void method2() {
		...
		// 		문자열의 beginIndex부터 endIndex -1 까지 (endIndex가 생략되면 끝까지)
		// 		의 문자열을 새로 생성해서 리턴
	...
	public void method4() {
		...
		String str = "HTML,CSS,JavaScript,JDBC,Servlet,JSP,jQuery,MyBatis,Spring,React";
		...
		// hseMoreTokens : 남아 있는 토큰이 있는지 확인
