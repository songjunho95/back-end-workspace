...
public class Application {
	...
	private MusicController mc - new MusiCintroller();
	...
	public void searchMusic() {
		...
		System.out.println("이영지 - Small girl 을 검색했습니다.");
	...
	public void removeMusic() {
		...
		System.out.println("삭제할 곡이 없습니다.");
		System.out.println("NewJeans - How Sweet 을 삭제했습니다.");
	...
	public void updateMusic() {
		...
		String artist = sc.nextLine();
		mc.updateMusic(search, new Music(artist, song));
		if(music !=null) {
