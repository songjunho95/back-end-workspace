 ...
 * 
 *  차이점
 *  - 추상클래스는 abstract 키워드로 클래스가 정의도이어있고 클래스 내에 변수, 메서드 생성 가능
 *  - 인터페이스는 interface 키워드로 정의되어 있고 인터페이스 내에 변수, 메서드 생성 불가능
 *  
 *  extends와 implements
 *  - 클래스 간의 상속 관계일 떄 : 자식 클래스명 extends 부모 클래스명
 *  - 클래스와 인터페이스의 구현 관계일 떄 : 구현 클래스명 implements 인터페이스명, 인터페이스명...
...
//			Vehicle v = new Vehicle(); -> 인터페이스 객체 생성 x
	...
	/*
	 * 추상 클래스 : 미완성 설계도, 인터페이스 : 기본 설계도 개발방법론 ; 예전 - 폭포수 vs 요즘 - 애자일
	 * 
	 * 
	 */
