...
import com.kh._abstract.step1.Taxi;
 ...
 * 
 * - 인터페이슨느 개발 코드와 객체가 서로 통신하는 접점 역할을 한다.
 * - 인터페이스에서 변수는 무조건 상수이다.
 * - 인터페이스에서 메서드는 무조건 추상 메서드이다.
 * - 객체가 구현해야 하는 기능이 있을때 인터페이스에 추상 메서드를 추가해서 객체가 기능을 구현하도록 만들 수 있다.
 * - 인터페이스를 구현하려면 implements 키웓르르 사용한다.
 ...
 * 
 * 차이점
 * - 추상클래스 abstract 키워드로 클래스가 정의되어 있고 클래스 내에 변수, 메서드 생성 가능
